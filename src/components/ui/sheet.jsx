...
function Sheet({ ...props }) {
  return React.createElement(SheetPrimitive.Root, {
    "data-slot": "sheet",
    ...props
  });
}
...
function SheetTrigger({
  ...
  return React.createElement(SheetPrimitive.Trigger, {
...
function SheetClose({
  ...
  return React.createElement(SheetPrimitive.Close, {
...
function SheetPortal({
  ...
  return React.createElement(SheetPrimitive.Portal, {
