...
function DropdownMenu({
  ...
  return React.createElement(DropdownMenuPrimitive.Root, {
...
function DropdownMenuTrigger({
  ...
  return React.createElement(DropdownMenuPrimitive.Trigger, {
...
function DropdownMenuGroup({
  ...
  return React.createElement(DropdownMenuPrimitive.Group, {
...
function DropdownMenuRadioGroup({
  ...
  return React.createElement(DropdownMenuPrimitive.RadioGroup, {
...
function DropdownMenuSub({
  ...
  return React.createElement(DropdownMenuPrimitive.Sub, {
