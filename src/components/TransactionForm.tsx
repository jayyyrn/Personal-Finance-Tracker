...
import { Category, TransactionData, TransactionType } from "../types"; // ✅ Make sure types.ts includes TransactionType

interface TransactionFormProps {
  categories: Category[];
  onTransactionAdded: () => void;
  onAddTransaction: (data: TransactionData) => Promise<any>;
}
